...
public class SubscriberMethodInfo {
    ...
    public SubscriberMethodInfo(String methodName, Class<?> eventType, ThreadMode threadMode,
                                int priority, boolean sticky, String channel) {
    ...
    public SubscriberMethodInfo(String methodName, Class<?> eventType, ThreadMode threadMode, String channel) {
        this(methodName, eventType, threadMode, 0, false, channel);
    }
